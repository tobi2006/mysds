...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnonymousMarks'
        db.create_table(u'anonymous_marking_anonymousmarks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['database.Module'])),
            ('exam_id', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.send_create_signal(u'anonymous_marking', ['AnonymousMarks'])

        # Adding unique constraint on 'AnonymousMarks', fields ['module', 'exam_id']
        db.create_unique(u'anonymous_marking_anonymousmarks', ['module_id', 'exam_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AnonymousMarks', fields ['module', 'exam_id']
        db.delete_unique(u'anonymous_marking_anonymousmarks', ['module_id', 'exam_id'])

        # Deleting model 'AnonymousMarks'
        db.delete_table(u'anonymous_marking_anonymousmarks')


    models = {
        u'anonymous_marking.anonymousmarks': {
            'Meta': {'ordering': "['module', 'exam_id']", 'unique_together': "(('module', 'exam_id'),)", 'object_name': 'AnonymousMarks'},
            ...
            'exam_id': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
    ...
    complete_apps = ['anonymous_marking']