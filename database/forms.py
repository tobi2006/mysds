...
class StudentForm(forms.ModelForm):
    ...
    tutor = UserModelChoiceField(
        User.objects.filter(
            groups__name='teachers').order_by('first_name', 'last_name'),
        required=False,
    ...
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.Textarea(
                attrs={'rows': 6, 'cols': 20, 'class': 'form-control'}),
            'home_address': forms.Textarea(
                attrs={'rows': 6, 'cols': 20, 'class': 'form-control'}),
            'phone_no': forms.TextInput(attrs={'class': 'form-control'}),
            'permanent_email': forms.TextInput(
            ...
            'is_part_time': forms.CheckboxInput(
                attrs={'class': 'form-control'}),
...
class ModuleForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'number_of_sessions': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_1_title': forms.TextInput(
                attrs={
                    'class': 'form-control',
                    'placeholder': 'Title of the assessment - eg Essay, Court\
Report, Critical Narrative'
                    }),
            'assessment_1_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_1_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_1_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_1_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
                ),
            'assessment_2_title': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_2_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_2_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_2_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_2_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
                ),
            'assessment_3_title': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_3_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_3_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_3_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_3_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
                ),
            'assessment_4_title': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_4_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_4_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_4_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_4_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
                ),
            'assessment_5_title': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_5_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_5_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_5_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_5_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
                ),
            'assessment_6_title': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_6_value': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_6_marksheet_type': forms.Select(
                attrs={'class': 'form-control'}),
            'assessment_6_max_word_count': forms.TextInput(
                attrs={'class': 'form-control'}),
            'assessment_6_submission_date': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control'
                    }
...
class TuteeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'date_of_meet': forms.DateInput(
                attrs={
                    'data-date-format': 'dd/mm/yyyy',
                    'class': 'form-control',
                    'placeholder': 'Date of meeting, e.g. 20/6/1980'
                    }
                ),
