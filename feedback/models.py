...
class FeedbackCategories(models.Model):
    ...
    category_3 = models.CharField(max_length = 30, blank=True)
    category_3_helptext = models.TextField(blank=True)
    category_4 = models.CharField(max_length = 30, blank=True)
    category_4_helptext = models.TextField(blank=True)
    category_5 = models.CharField(max_length = 30, blank=True)
    category_5_helptext = models.TextField(blank=True)
    category_6 = models.CharField(max_length = 30, blank=True)
