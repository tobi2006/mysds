...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupPart'
        db.create_table(u'feedback_grouppart', (
        ...
        db.send_create_signal(u'feedback', ['GroupPart'])


    def backwards(self, orm):
        # Deleting model 'GroupPart'
        db.delete_table(u'feedback_grouppart')
