...
urlpatterns += patterns('database.views',
    ...
    url(r'^address_nines/(\w+)/(\d{4})/$', 'address_nines', name = 'address_nines'),
    ...
    url(r'^assessment_groups/(\w+)/(\d{4})/$', 'assessment_groups', name = 'assessment_groups'),
...
urlpatterns += patterns('feedback.views',
    url(r'^essay_feedback/(\w+)/(\d{4})/(\d{1})/(\w+)$', 'edit_feedback', name = 'edit_feedback'),
