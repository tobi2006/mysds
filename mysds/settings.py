...
DATABASES = {
    'default': {
        ...
        'NAME': 'mysds.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4k3=0b-z_vq0sx!4ke#(b@_wp-#v$*pxxagkt*8897u43tslcf'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "database.context_processors.menubar"
)
