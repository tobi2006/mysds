...
def show_homepage(request):
    ...
    if is_student(request.user):
        ...
        if is_admin(request.user):
            announcements = Announcement.objects.filter(Q(announce_to='teachers') | Q(announce_to='all'))
            admin = True
    ...
    return render_to_response('home.html',
            {'announcements': announcements, 'mdexplanation': MD_EXPLANATION, 'admin': admin},
